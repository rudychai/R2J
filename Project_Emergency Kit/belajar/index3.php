                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form method="POST" action="cek.php" name="submit" autocomplete="on"> 
                                <h1> Sign up </h1> 
                                <p> 
                                ...
                                <p> 
                                    ...
                                    <input id="email" name="email" required="required" type="email" placeholder="Example@email.com"/> 
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p">Your password </label>
                                ...
                                <p> 
                                    ...
                                    <input id="passwordsignup_confirm" name="comfirmpass" required="required" type="password" placeholder="Confirm password"/>
                                </p>
