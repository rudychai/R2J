			...
			<div class="container">
						...
						<!-- Collect the nav links, forms, and other content for toggling -->
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav navbar-right link-effect">
									...
									<li><a href="LoginRegistrationForm/LoginAndRegis.php" class="btn" >Login</a>
				...
				<div class="banner-info">
					<div class="logo wow fadeInRight animated" data-wow-delay=".5s">
						...
						<p class="wow fadeInRight animated" data-wow-delay=".5s">Do you live in Medan? Are you in danger situation? Do you feel threatened? Don't Panic!</p>
						<p class="wow fadeInRight animated" data-wow-delay=".5s">Use your mobile phone or this website to Help!</p>
				</div>
				...
				<div class="container">
					...
					<div class="service-grids">
						...
						<div class="col-md-4 ser-grid">
							...
							<div class="ser-right">
								<h4 style="cursor: pointer;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal8" style="text-decoration: none; color: white;">Profile Setting</a></h4>
					...
					<div class="service-grids">
						<div class="col-md-4 ser-grid">
							...
							<div class="ser-right">
								<h4 style="cursor: pointer;"><a href="map.html" style="text-decoration: none; color: white;">Recommended Place</a></h4>
						...
						<div class="col-md-4 ser-grid">
							...
							<div class="ser-right">
								<h4 style="cursor: pointer;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal8" style="text-decoration: none; color: white;">Worker Status</a></h4>
				...
				<div class="container">
					...
					<div class="journal-grids">
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">1</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">Earthquake</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">2</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal2">Fire</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">3</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal3">Health</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
					...
					<div class="journal-grids">
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">4</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal4">Heart Attack</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">5</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal5">Burglar</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h3 style="color: white; padding-top: 16px; padding-bottom: 16px;">6</h3>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal6">Accident</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
				...
				<div class="container">
					...
					<div class="journal-grids">
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h5 style="padding-top: 16px; padding-bottom: 16px;">1</h5>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal7">Police</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h5 style="padding-top: 16px; padding-bottom: 16px;">2</h5>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal8">Ambulance</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
						...
						<div class="col-md-4 journal-grid">
							...
							<div class="jou-text">
								<div class="jou-left">
									<h5 style="padding-top: 16px; padding-bottom: 16px;">3</h5>
								</div>
								<div class="jou-right">
									<h4 style="padding-top: 7px;"><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal9">FireFighter</a></h4>
								</div>
								<div class="clearfix"></div>
							</div>
			...
			<div class="modal fade" id="myModal7" tabindex="-1" role="dialog">
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<h3 class="tittle">You must login first!</h3>
